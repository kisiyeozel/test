<?php $__env->startSection('title', "Kisiyeozel.org Ürünleri"); ?>

<?php $__env->startSection('content'); ?>
<div style="background: linear-gradient(to right, #2b2620, #1a1713, #2b2620);" class="border-b border-gold-500/20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="flex items-center gap-4 mb-2">
            <div class="gold-line"></div>
            <span class="text-gold-400 text-sm tracking-[0.2em] uppercase font-sans font-medium">Kendi Markamız</span>
        </div>
        <h1 class="text-3xl md:text-4xl font-serif font-bold text-white mb-3">Kisiyeozel.org Ürünleri</h1>
        <p class="text-dark-300 font-sans text-sm md:text-base"><?php echo e($urunler->total()); ?> ürün bulundu</p>
    </div>
</div>
        ...
        <aside class="lg:w-64 shrink-0">
            <div class="luxury-card p-6 sticky top-24">
                ...
                <div class="mb-7">
                    ...
                    <div class="space-y-2">
                        <a href="<?php echo e(route('kendi-urunlerimiz')); ?>" class="block text-sm <?php echo e(!request('kategori') ? 'text-gold-600 font-semibold' : 'text-dark-500 hover:text-gold-600'); ?> transition font-sans flex items-center gap-2">
                        ...
                        <?php $__currentLoopData = $kategoriler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('kendi-urunlerimiz', ['kategori' => $kategori->id])); ?>" class="block text-sm <?php echo e(request('kategori') == $kategori->id ? 'text-gold-600 font-semibold' : 'text-dark-500 hover:text-gold-600'); ?> transition font-sans flex items-center gap-2">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <?php $__currentLoopData = ['yeni' => 'En Yeni', 'artan' => 'Fiyat (Artan)', 'azalan' => 'Fiyat (Azalan)', 'cok_satan' => 'Çok Satanlar']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('kendi-urunlerimiz', ['siralama' => $key])); ?>" class="block text-sm <?php echo e(request('siralama') == $key ? 'text-gold-600 font-semibold' : 'text-dark-500 hover:text-gold-600'); ?> transition font-sans flex items-center gap-2">
...
<?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-span-full text-center py-20">
                        <div class="w-20 h-20 mx-auto bg-cream-100 rounded-2xl flex items-center justify-center mb-5"><i class="fas fa-store text-3xl text-dark-300"></i></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\yenideneme\resources\views/kendi-urunlerimiz.blade.php ENDPATH**/ ?>