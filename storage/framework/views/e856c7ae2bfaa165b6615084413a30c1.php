...
<div class="grid md:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl border p-6">
        ...
        <form action="<?php echo e(route('admin.kupon-ekle')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <div class="divide-y">
            <?php $__currentLoopData = $kuponlar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-4 flex items-center justify-between">
                    <div>
                        <span class="font-mono font-bold text-gray-900"><?php echo e($kupon->kupon_kodu); ?></span>
                        <span class="text-sm text-gray-500 ml-2"><?php echo e($kupon->indirim_turu == 'yuzde' ? '%' . number_format($kupon->indirim_miktari, 0) : number_format($kupon->indirim_miktari, 2) . ' ₺'); ?></span>
                        <span class="text-xs text-gray-400 block"><?php echo e($kupon->kullanim_sayisi); ?>/<?php echo e($kupon->max_kullanim ?: '∞'); ?> kullanım</span>
                    </div>
                    <form action="<?php echo e(route('admin.kupon-sil', $kupon->id)); ?>" method="POST" onsubmit="return confirm('Emin misiniz?')">
    ...
    <div class="mt-4"><?php echo e($kuponlar->links()); ?></div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\yenideneme\resources\views/admin/kuponlar.blade.php ENDPATH**/ ?>