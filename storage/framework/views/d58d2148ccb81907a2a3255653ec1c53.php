...
<body>
    ...
    <div class="card">
        ...
        <div class="btn-group">
            <a href="<?php echo e(url('/')); ?>" class="btn"><i class="fas fa-arrow-left"></i>Beni Kurtar</a>
            <a href="<?php echo e(url('/magazalar')); ?>" class="btn-outline"><i class="fas fa-store"></i>Mağazalarımıza Göz Atın</a>
        </div>

        <div class="links">
            <a href="<?php echo e(url('/')); ?>">Ana Sayfa</a>
            <a href="<?php echo e(url('/products')); ?>">Ürünler</a>
            <a href="<?php echo e(url('/magazalar')); ?>">Mağazalar</a>
            <a href="<?php echo e(url('/blog')); ?>">Blog</a>
            <a href="<?php echo e(url('/contact')); ?>">İletişim</a>
        </div>
    ...
    <div class="game-overlay-msg" id="winOverlay">
        <div class="box">
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn"><i class="fas fa-arrow-left"></i>Ana Sayfaya Dön</a>
...
<?php /**PATH C:\xampp\htdocs\yenideneme\resources\views/errors/404.blade.php ENDPATH**/ ?>